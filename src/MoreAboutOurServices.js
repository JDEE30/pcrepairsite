...
<h2 className="swotitle">More about our PC Repair Services in San Antonio</h2>
     <div class="row">
       <div class="col s12 m4">
         <div class="icon-block">
           ...
           After we get this information, then we can get to work.</p>
            ...
            <h5 class="center">What is a Virus Removal or windows unlock Repair?</h5>
            <p class="light">This Pc Repair in San Antonio or surrounding areas entials several things. Assuming you have a virus or are locked out of your device we would take the following steps for this pc repair. </p>

            <ol><li>We'll need phsyical access to your device.</li>
            ...
            <li>If step four does not work and your data can not be recovered we will provide you with a fresh install of windows and a new hdd/sdd/m2.</li>
            <li>this repair normally can be done in 30 minutes to an hour after parts are sourced and the repair time can vary depending on the speed of your device.</li>          
            </ol>
          </div>
       </div>
       ...
       <div class="col s12 m4">
         <div class="icon-block">
           ...
           <h5 class="center">What is a PC Screeen Repair/Laptop/Desktop PC Repair?  </h5>
            <p class="light">This Pc Repair in San Antonio or surrounding areas entials several things. Assuming you have a cracked or broken screen/keyboard/usbport/etc on your device we would take the following steps for this pc repair. </p>
         
            <ol><li>We'll need phsyical access to your device.</li>
            <li>We will need to source parts depending on the device we normally only care parts for phone screen repairs</li>
            <li>Once parts are sourced either by us or by the customer, we would begin the repair</li>
            <li>this repair normally can be done in 30 minutes to an hour after parts are sourced</li>
       ...
       <div class="col s12 m4">
         <div class="icon-block">
           ...
           <h5 class="center">What are Operating System Upgrades/Hardware Upgrade Repairs?  </h5>
            <p class="light">This Pc Repair in San Antonio or surrounding areas entials several things. Assuming you need a new version of windows/mac/linux or new ram, hard drive space, etc on your device we would take the following steps for this pc repair. </p>
         
            <ol><li>We'll need phsyical access to your device.</li>
            <li>We will need to source parts depending on the device we normally have hard drives(hdd/ssd/nvme) on hand</li>
            <li>Once parts are sourced either by us or by the customer, we would begin the repair</li>
            <li>this repair normally can be done in 30 minutes to an hour depending on the current speed of your device after parts are sourced</li>
             </ol>
 ...
 <div class="container">
            <div class="section">
              ...
              <div class="col s12 m4">
                  <div class="icon-block">
                    ...
                    <h5 class="center">What is a Peripheral Connection pc Repair?  </h5>
            <p class="light">This Pc Repair in San Antonio or surrounding areas entials several things. Normally, you would be having issues connecting peripherals(keyboards, mice, speakers, printers, cash registers, etc)to one or more of your devices to qualify for this pc repair. </p>
            ...
            <li>Once parts are sourced either by us or by the customer, we would begin the repair</li>
            <li>this repair normally can be done in 10-15 minutes depending on the current speed of your device after parts/softwares are sourced</li>
             </ol>
                  </div>
                </div>
